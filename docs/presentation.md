...
A simple web application created to demonstrate:

* how to easily develop a Single Page Application (SPA) with Quarkus
* how AI services can be integrated into a Quarkus application
* how the Model Context Protocol (MCP) works
* how observability works and why it is especially valuable in the context of AI
...
LangChain4j is a Java framework for building LLM-powered applications, providing abstractions for **prompt** templates, **tool/function** calling, **memory**, and **RAG** pipelines to integrate AI capabilities cleanly into JVM systems.
...
## Message Template - AI Components

Programmatic vs declarative

* **@SystemMessage**: initial instructions/context for the LLM interaction
* **@UserMessage**: user instructions/prompts sent to the LLM
* **@RegisterAiService**: marks an interface as a CDI managed AI Service
* **@McpToolBox**
* **@Tool**
...
* **system**: sets the overall behavior, tone, or instructions for the LLM.
* **user**: input from the user.
* **assistant**: the response generated by the LLM.
* **function call**: special message used by the LLM to request the invocation of a function.
* **function result**: carries the result of a function call back to the model.
